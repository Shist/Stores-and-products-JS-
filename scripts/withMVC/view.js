...
class View {
  ...
  /**
   * Adds class with given className to class list of given element
   * @param {HTMLElement} element DOM element that needs to add class
   * @param {string} className the name of the class to add
   * @returns {View} self object (for chaining ability)
   * @public
   */
  addClassForElement(element, className) {
  ...
  /**
   * Removed class with given className from class list of given element
   * @param {HTMLElement} element DOM element that needs to remove class
  ...
  /**
   * Inserts given HTML structure inside given element via given position
   * @param {HTMLElement} element DOM element that needs to insert HTML structure
   * @param {string} position position of inserting ("beforebegin", "afterbegin", "beforeend", "afterend")
   * @param {string} structure HTML structure to be added
   * @returns {View} self object (for chaining ability)
   * @public
   */
  insertHTMLInsideElement(element, position, structure) {
    element.insertAdjacentHTML(position, structure);

    return this;
  }

  /**
   * Changes inline height of given element via given height
   * @param {HTMLElement} element DOM element that needs to change inline height
   * @param {string} newHeight new value of height
   * @returns {View} self object (for chaining ability)
   * @public
   */
  changeElementInlineHeight(element, newHeight) {
  ...
  /**
   * Changes inline top offset of given element via given top offset
   * @param {HTMLElement} element DOM element that needs to change inline top offset
   * @param {string} newTopOffset new value of top offset
   * @returns {View} self object (for chaining ability)
   * @public
   */
  changeElementInlineTopOffset(element, newTopOffset) {
    element.style.top = newTopOffset;

    return this;
  }

  /**
   * Changes inline width of given element via given width
   * @param {HTMLElement} element DOM element that needs to change inline width
   * @param {string} newWidth new value of width
   * @returns {View} self object (for chaining ability)
   * @public
   */
  changeElementInlineWidth(element, newWidth) {
  ...
  /**
   * Updates products table head via given sorting order value (usually from model)
   * @param {string} defaultSortOrder string containing default sorting order value (usually from model)
   * @returns {View} self object (for chaining ability)
   * @public
   */
  updateProductsTableHead(defaultSortOrder) {
    this.getProductsTableHead().innerHTML =
      this.getStructureForTableHead(defaultSortOrder);
